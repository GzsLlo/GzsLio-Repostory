...
<link rel="stylesheet" href="${base}/static/css/modules/test/simsDiagnostic.css"/>
<script type="text/javascript" src="${base}/static/js/modules/test/simDiagnostic.js"></script>
