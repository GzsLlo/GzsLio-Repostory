...
<!-- BEGIN CSS -->
<link rel="stylesheet" href="${pageContext.request.contextPath}/static/css/modules/test/simsDiagnostic.css">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row">
          ...
          <div class="col-md-8">
            <textarea id="msgContent" style="width: 100%;height: 200px" maxlength="320"
